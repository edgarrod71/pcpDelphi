inherited fn1_refe_fich_edic_07_medi_especiales: Tfn1_refe_fich_edic_07_medi_especiales
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited padr_tabl_fich_Detalles: TkbmMemTable
    ...
    object padr_tabl_fich_DetallesIMAG_1: TBlobField [0]
      FieldName = 'IMAG_1'
      Origin = 'DATA_BASE_PCP.PCP_REFE_FICH_07_MEDI_ESPECIAL.IMAG_1'
      BlobType = ftBlob
      Size = 1
    end
    object padr_tabl_fich_DetallesIMAG_1_SMALL: TBlobField [1]
      FieldName = 'IMAG_1_SMALL'
      Origin = 'DATA_BASE_PCP.PCP_REFE_FICH_07_MEDI_ESPECIAL.IMAG_1_SMALL'
      BlobType = ftBlob
      Size = 1
    end
  end
  ...
  object quer_guar_detalle: TQuery
    ...
    DataSource = data_tabl_fich_Detalles
    SQL.Strings = (
      'EXECUTE PROCEDURE PRO_PCP_REFE_FICH_07_MEDI_IU'
      '(:CONS_REFE_FICHA, '
      ':IMAG_1, '
      ':IMAG_1_SMALL)')
    Left = 556
