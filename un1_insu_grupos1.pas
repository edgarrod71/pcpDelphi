...
type
  Tfn1_insu_grupos1 = class(T_fvent_modal)
    Panel1: TPanel;
    SCLDBLabel1: TSCLDBLabel;
    SCLDBLabel2: TSCLDBLabel;
    SCLDBLabel3: TSCLDBLabel;
    Tabla_VentanaCONS_INSU_GRUPO: TIntegerField;
    Tabla_VentanaCODI_INSU_GRUPO: TStringField;
    Tabla_VentanaNOMB_INSU_GRUPO: TStringField;
...
var
  fn1_insu_grupos1: Tfn1_insu_grupos1;
