inherited FN1_Refe_Presentacion: TFN1_Refe_Presentacion
  Left = 273
  Top = 172
  OldCreateOrder = True
  PixelsPerInch = 96
    ...
    inherited padr_pagina: TdxPageControl
      inherited fram_pagi_lista: TdxTabSheet
        inherited padr_grid: TSCLDBGrid
          ...
          object padr_gridCONS_SEXO: TdxDBGridMaskColumn
            Visible = False
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CONS_SEXO'
          ...
          object padr_gridGRUP_TALLAS: TdxDBGridMaskColumn
            Width = 200
            BandIndex = 0
            RowIndex = 0
  ...
  inherited padr_titu_ventana: TPanel
    inherited padr_pane_titulo: TPCPTituloGradiente
      LabelCaption = 'Materiales de Empaque (Referencias)'
      Caption = 'Materiales de Empaque (Referencias)'
    end
  end
  ...
  inherited consulta: TQuery
    ...
    object consultaCODI_REFE_TIPO_VARIACION: TStringField
    ...
    object consultaCONS_SEXO: TIntegerField
    ...
    object consultaGRUP_TALLAS: TStringField
      DisplayLabel = 'Tallas'
      FieldName = 'GRUP_TALLAS'
      Size = 100
    end
  ...
  inherited Variables: TSCLPropiedadesForm
    CampoAMostrar = 'NOMB_REFERENCIA'
    NombreAMostrar = 'Referencia'
    CamposDeBusqueda = 'CONS_REFE_VARIACION'
    TipoGenero = geLa
    TablaMaestra = 'CON_GLO_REFERENCIAS'
  end
  object QExiste_Presentacion: TQuery
    DatabaseName = 'data_base_pcp'
    DataSource = data_ventana
    SQL.Strings = (
      'SELECT COUNT(*) AS EXISTE'
      'FROM PCP_REFE_VARI_PRESENTACION'
