...
type
  Trn1_refe_fich_tecn_07_espe_empaque = class(Trn1_refe_fich_tecn_base)
...
var
  rn1_refe_fich_tecn_07_espe_empaque: Trn1_refe_fich_tecn_07_espe_empaque;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Trn1_refe_fich_tecn_07_espe_empaque.FormCreate(
  Sender: TObject);
begin
  inherited;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Trn1_refe_fich_tecn_07_espe_empaque.acti_post_prepareExecute(
  Sender: TObject);
begin
  inherited;
