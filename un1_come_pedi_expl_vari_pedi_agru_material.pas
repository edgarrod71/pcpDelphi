...
{*******************************************************************
        Unit            : un1_come_pedi_expl_vari_pedi_agru_material
...
type
  Tfn1_come_pedi_expl_vari_pedi_agru_material = class(T_fvent_child)
...
var
  fn1_come_pedi_expl_vari_pedi_agru_material: Tfn1_come_pedi_expl_vari_pedi_agru_material;
...
Objetivo        : Ejecutar el asistente de filtro de pedidos
Realizado por   : Mauricio Vargas Echeverry
Fecha           : Febrero 02 de 2005
Versión         : pcp4.0.20.0
*****************************************************************}
procedure Tfn1_come_pedi_expl_vari_pedi_agru_material.boto_asistenteClick(
  Sender: TObject);
var
    var_filtro  : String;
begin
...
procedure Tfn1_come_pedi_expl_vari_pedi_agru_material.FormCreate(
  Sender: TObject);
begin
  inherited;
