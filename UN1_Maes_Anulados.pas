...
uses
  ...
  PCPLookUpComboEdit, SoSplit, dxTL, dxDBCtrl, dxDBGrid, dxDBTLCl, dxGrClms,
  RxMemDS, PCPProceso;

type
  TFN1_Maes_Anulados = class(T_fvent_modal)
    PCPFrame1: TPCPFrame;
...
var
  FN1_Maes_Anulados: TFN1_Maes_Anulados;
...
procedure TFN1_Maes_Anulados.Consultar_Movimientos;
Var
	I : Integer;
  Personal : String;
Const
...
procedure TFN1_Maes_Anulados.DBPersonalSelectedCountChange(
  Sender: TObject);
begin
  inherited;
...
procedure TFN1_Maes_Anulados.Acti_Anular_MovimientosExecute(
  Sender: TObject);
Var
	I : Integer;
Const
...
procedure TFN1_Maes_Anulados.TAnuladosBeforePost(DataSet: TDataSet);
begin
  inherited;
  ValidarDatosDataSet(TAnulados);
end;

procedure TFN1_Maes_Anulados.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFN1_Maes_Anulados.DBPersonalChangeNodeEx(Sender: TObject);
begin
  inherited;
  Consultar_Movimientos;
end;
