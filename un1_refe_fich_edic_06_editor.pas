...
{*******************************************************************
        Unit            : un1_refe_fich_edic_06_editor
...
var
  fn1_refe_fich_edic_06_editor: Tfn1_refe_fich_edic_06_editor;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.FormCreate(Sender: TObject);
begin
        ...
        Shap_2.Brush.Color := clLineaGradiente;
        //Abrir las consultas
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.tabl_ventanaBeforeInsert(
  DataSet: TDataSet);
begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.pane_cont_imagenResize(
  Sender: TObject);
begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.FormClose(Sender: TObject;
...
Versión         : pcp4.0.20.10
*****************************************************************}
Procedure Tfn1_refe_fich_edic_06_editor.SetTitulo (peTitulo : String);
Begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.FormActivate(Sender: TObject);
begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.FormDeactivate(Sender: TObject);
begin
        pane_titulo.SetHardColors(False);
        var_Seleccionada := False;
end;
...
Versión         : pcp4.0.20.10
*****************************************************************}
Procedure Tfn1_refe_fich_edic_06_editor.Ejecutar(peCons_Refe_Fich_Detalle, peCons_Refe_Ficha : Integer);
Begin
     var_Loading := True;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.chec_eliminarChange(
  Sender: TObject);
begin
        //Cambiar el estado y color de los controles
        pane_imagen.Visible := Not Chec_Eliminar.Checked;
        edit_observaciones.Visible := Not chec_Eliminar.Checked;
        shap_1.Visible := Chec_Eliminar.Checked;
        shap_2.Visible := chec_Eliminar.Checked;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.data_VentanaStateChange(
  Sender: TObject);
begin
     //Validar
...
Versión         : pcp4.0.20.10
*****************************************************************}
Procedure Tfn1_refe_fich_edic_06_editor.Guardar;
Begin
    var_Saving := True;
    ...
    if (tabl_Ventana.FieldByName('cons_refe_fich_detalle').asInteger = 0) Then
        ...
        tabl_Ventana.FieldByName('cons_Refe_fich_Detalle').Value := GenerarSecuencia('PCP_REFE_FICH_06_ESPE_CONS', 'CONS_REFE_FICH_DETALLE');
    //Registro del padre
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_06_editor.tabl_ventanaBeforePost(
  DataSet: TDataSet);
begin
