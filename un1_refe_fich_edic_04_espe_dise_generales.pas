...
{*******************************************************************
        Unit            : un1_refe_fich_edic_04_espe_dise_generales
        Objetivo        : Ventana de edición de fichas técnicas
                          04 - ESPECIFICACIONES DISEÑO DETALLES
...
type
  Tfn1_refe_fich_edic_04_espe_dise_generales = class(Tfn1_refe_fich_00Edicion)
...
var
  fn1_refe_fich_edic_04_espe_dise_generales: Tfn1_refe_fich_edic_04_espe_dise_generales;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_04_espe_dise_generales.FormCreate(
  Sender: TObject);
begin
  inherited;
  TipoFicha := ftdEspecificacionesDisenoDetalles;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_04_espe_dise_generales.padr_pane_deta_fichaResize(
  Sender: TObject);
begin
  inherited;
...
Objetivo        : Ejecutar el AFTER-POST de la ventana
Realizado por   : Mauricio Vargas Echeverry
Fecha           : 03-Jun-2005
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_04_espe_dise_generales.padr_acti_AfterPostExecute(
  Sender: TObject);
begin
  inherited;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_04_espe_dise_generales.padr_acti_AfterEjecutarExecute(
  Sender: TObject);
begin
  inherited;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_04_espe_dise_generales.padr_tabl_fich_DetallesBeforePost(
  DataSet: TDataSet);
begin
  inherited;
