object ffra_prod_expl_tejidos: Tffra_prod_expl_tejidos
  Left = 0
  Top = 0
  Width = 804
  Height = 417
  ...
  object fram_grid: TdxDBGrid
    ...
    PreviewFont.Style = []
    ShowRowFooter = True
    object dxDBGrid1CONS_REFE_MATERIAL: TdxDBGridMaskColumn
    ...
    object dxDBGrid1CONS_MATE_REFERENCIA: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 117
      BandIndex = 0
    ...
    object dxDBGrid1CODI_MATE_REFERENCIA: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 115
      BandIndex = 0
    ...
    object dxDBGrid1NOMB_MATE_REFERENCIA: TdxDBGridMaskColumn
      Caption = 'Referencia de material'
      HeaderAlignment = taCenter
      Sorted = csUp
      Visible = False
      Width = 119
    ...
    object dxDBGrid1CONS_MATE_GRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 94
      BandIndex = 0
    ...
    object dxDBGrid1CODI_MATE_GRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 91
      BandIndex = 0
    ...
    object dxDBGrid1NOMB_MATE_GRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 293
      BandIndex = 0
    ...
    object dxDBGrid1CONS_MATE_SUBGRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 111
      BandIndex = 0
    ...
    object dxDBGrid1CODI_MATE_SUBGRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 108
      BandIndex = 0
    ...
    object dxDBGrid1NOMB_MATE_SUBGRUPO: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 293
      BandIndex = 0
    ...
    object dxDBGrid1ES_PRINCIPAL: TdxDBGridMaskColumn
      HeaderAlignment = taCenter
      Visible = False
      Width = 66
      BandIndex = 0
  ...
  object quer_explosion: TQuery
    ...
    SQL.Strings = (
        ...
        'Select * from con_pcp_prod_expl_materiales (:cons_prod_orden,  :' +
        'nume_lote,'
      ':es_principal, :etapa)'
    ...
    object quer_explosionES_PRINCIPAL: TIntegerField
      FieldName = 'ES_PRINCIPAL'
    end
