object ffra_prod_tota_trazo: Tffra_prod_tota_trazo
  Left = 0
  Top = 0
  Width = 506
  Height = 247
  ...
  object quer_tallas: TQuery
    ...
    SQL.Strings = (
      'SELECT DISTINCT CONS_GRUP_TALL_DETALLE,'
      'SECU_TALLA, TALLA'
      'FROM VIS_PCP_PROD_ESPI_TALLAS'
  ...
  object quer_colores: TQuery
    ...
    SQL.Strings = (
      ...
      'FROM VIS_PCP_PROD_ESPI_COLORES'
      'WHERE CONS_PROD_ORDEN = :CONS_PROD_ORDEN'
      'ORDER BY SECU_COLOR')
    Left = 49
    Top = 107
