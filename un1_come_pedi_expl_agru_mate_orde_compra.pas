...
{*******************************************************************
        ...
        Objetivo        : Explosión de materiales por pedido
                          agrupada por el tipo de material/insumo
        Realizado por   : Mauricio Vargas Echeverry
        Fecha           : Noviembre 24 de 2004
        Versión         : pcp4006
*******************************************************************}
unit un1_come_pedi_expl_agru_mate_orde_compra;
...
type
  Tfn1_come_pedi_expl_agru_mate_orde_compra = class(Tfn1_come_expl_padre)
...
var
  fn1_come_pedi_expl_agru_mate_orde_compra: Tfn1_come_pedi_expl_agru_mate_orde_compra;
...
procedure Tfn1_come_pedi_expl_agru_mate_orde_compra.FormCreate(
  Sender: TObject);
begin
  inherited;
