...
{*******************************************************************
        Unit            : un1_refe_fich_edic_09_espe_presentacion
        Objetivo        : Ventana de edición de fichas técnicas
                          09 - ESPECIFICACIONES DE PRESENTACIÓN
...
type
  Tfn1_refe_fich_edic_09_espe_presentacion = class(Tfn1_refe_fich_00Edicion)
...
var
  fn1_refe_fich_edic_09_espe_presentacion: Tfn1_refe_fich_edic_09_espe_presentacion;

implementation

uses un1_refe_fich_edic_09_editor, _cons_pcp, _func_varias, _cons_colores,
  _MDI, _Traductor;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.FormCreate(
  Sender: TObject);
begin
  inherited;
  TipoFicha := ftdEspecificacionesPresentacion;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.padr_acti_AfterEjecutarExecute(
  Sender: TObject);
Var
        var_Ventana : Tfn1_refe_fich_edic_09_editor;
        var_i   : Integer;
begin
  inherited;
  ...
  Begin
      ...
      Begin
          ...
          Begin
              ...
              Application.CreateForm(Tfn1_refe_fich_edic_09_editor, var_Ventana);
...
Versión         : pcp4.0.20.10
*****************************************************************}
Procedure Tfn1_refe_fich_edic_09_espe_presentacion.DestruirControles;
Var
        var_i : Integer;
Begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.FormDestroy(
  Sender: TObject);
begin
  DestruirControles;
  inherited;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.acti_nuev_imagenExecute(
  Sender: TObject);
Var
        var_Ventana : Tfn1_refe_fich_edic_09_editor;
begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.acti_elim_imagenUpdate(
  Sender: TObject);
begin
  inherited;
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.acti_elim_imagenExecute(
  Sender: TObject);
Var
        var_i   : Integer;
begin
  ...
  for var_i := 1 to pane_contenedor.ControlCount do
  Begin
      if (pane_Contenedor.Controls[var_i - 1] is Tfn1_refe_fich_edic_09_editor) then
      Begin
          //Marcar como eliminado
          if (pane_Contenedor.Controls[var_i - 1] as Tfn1_refe_fich_edic_09_editor).Seleccionada Then
          Begin
             (pane_Contenedor.Controls[var_i - 1] as Tfn1_refe_fich_edic_09_editor).chec_eliminar.Checked := True;
             Break;
          End;
      End;
  End;
...
Versión         : pcp4.0.20.10
*****************************************************************}
Procedure Tfn1_refe_fich_edic_09_espe_presentacion.ActualizarLabelNumeroImagenes;
Begin
...
Versión         : pcp4.0.20.10
*****************************************************************}
procedure Tfn1_refe_fich_edic_09_espe_presentacion.padr_acti_AfterPostExecute(
  Sender: TObject);
Var
        var_I   : Integer;
begin
  ...
  For var_i := 1 to pane_Contenedor.ControlCount do
     if (pane_Contenedor.Controls[Var_i -1] is Tfn1_refe_fich_edic_09_editor) Then
        (pane_Contenedor.Controls[Var_i -1] as Tfn1_refe_fich_edic_09_editor).Guardar;  
end;
