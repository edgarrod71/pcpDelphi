inherited FN1_Refe_Costura: TFN1_Refe_Costura
  Left = 245
  Top = 177
  OldCreateOrder = True
  PixelsPerInch = 96
  ...
  inherited padr_titu_ventana: TPanel
    inherited padr_pane_titulo: TPCPTituloGradiente
      LabelCaption = 'Especificaciones de Costura'
      Caption = 'Especificaciones de Costura'
    end
  end
  ...
  object QExiste_Costura: TQuery
    DatabaseName = 'data_base_pcp'
    DataSource = data_ventana
    SQL.Strings = (
      'SELECT COUNT(*) AS EXISTE'
      'FROM PCP_REFE_VARI_COSTURA'
