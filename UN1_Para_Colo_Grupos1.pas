...
type
  TFN1_Para_Colo_Grupos1 = class(T_fvent_modal)
    Tabla_VentanaCONS_COLO_GRUPO: TIntegerField;
    Tabla_VentanaCODI_COLO_GRUPO: TStringField;
    Tabla_VentanaNOMB_COLO_GRUPO: TStringField;
...
var
  FN1_Para_Colo_Grupos1: TFN1_Para_Colo_Grupos1;
...
procedure TFN1_Para_Colo_Grupos1.FormCreate(Sender: TObject);
begin
  inherited;
