...
Objetivo        : Se guarda la información de las demas tablas
Realizado por   : Gustavo Muñoz (DESARROLLO)
Fecha           : Junio 1 de 2004
Versión         : pcp4000
*****************************************************************}
...
begin
  ...
  If Tabla_Ventana.State = dsInsert Then Begin
    ...
    If TRecursos_Temporal.RecordCount < 1 Then Begin
      EjecutarMensaje('Ingrese la información del Recurso', mtConfirmation, [mbOk], 0);
      Abort;
    End;
    //Verifico que existan registros en la tabla de Traslados
    If TTraslados_Temporal.RecordCount < 1 Then Begin
      EjecutarMensaje('Ingrese la información de la Ubicación del Recurso', mtConfirmation, [mbOk], 0);
      Abort;
    End;
...
{  SetControlEnabled(PCRecurso, 	 	(Tabla_Ventana.State In [dsInsert, dsEdit]));
  ...
  case Tabla_Ventana.State of
    dsInsert : begin
      ...
      //Cambia los controles de las características
...
Objetivo        : Modificar los datos de los campos de ubicación
									según tipo de ubicación
Realizado por   : Gustavo Muñoz (DESARROLLO)
Fecha           : Junio 1 de 2004
Versión         : pcp4000
*****************************************************************}
...
begin
  inherited;
  //Se asigna el último consecutivo de la tabla
...
Objetivo        : Adicionar las caracteristicas seleccionadas
									en el grid de características Disponibles
Realizado por   : Gustavo Muñoz (DESARROLLO)
...
Objetivo        : Adiciono las características especiales del tipo
									de Recurso
Realizado por   : Gustavo Muñoz (DESARROLLO)
...
Objetivo        : Verifico que el valor de la característica especial
		  no quede vacio
Realizado por   : Gustavo Muñoz (DESARROLLO)
Fecha           : Miercoles Junio 9 de 2004
Versión         : pcp4000
...
//  QConsecutivo_Caracteristica.Close;  // Esto sobra aquí. by Edgarrod
end;

{****************************************************************
Procedimiento   : CBPrestamoChange
Objetivo        : Habilito / deshabilito la fecha de devolución
Realizado por   : Gustavo Muñoz (DESARROLLO)
Fecha           : Miercoles Junio 9 de 2004
Versión         : pcp4000
*****************************************************************}
...
Objetivo        : Elimino las caracteristicas seleccionadas
									en el grid de características Asignadas
Realizado por   : Gustavo Muñoz (DESARROLLO)
Fecha           : Lunes Junio 7 de 2004
Versión         : pcp4000
*****************************************************************}
