inherited RN1_Acce_Cons_Plantas: TRN1_Acce_Cons_Plantas
  Caption = 'Informe Accesorios por Plantas y Secciones'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited ScrollBox1: TScrollBox
    inherited _QRPadre: TPCPQuickReport
      ...
      inherited _QRBanda_Page_Header: TPCPQRBand
        ...
        object LTipos: tPCPQrLabel
          Left = 6
          Top = 107
          Width = 127
          Height = 17
          Hint = 'Tipos de Accesorios'
          Frame.Color = clBlack
          Frame.DrawTop = False
